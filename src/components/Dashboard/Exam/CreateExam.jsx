...
const CreateExam = () => {
  ...
  return (
    <div className="min-h-screen font-inter">
      <header className="bg-blue-600 text-white py-4 px-6 shadow-lg flex justify-between items-center mb-6">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
          <div className="bg-white shadow-2xl w-[40%] border-4 border-blue-500 overflow-hidden">
            <h2 className="text-2xl font-bold text-white bg-blue-500 px-6 py-4 text-center">
              {isEditing ? "Edit Question" : "Create Question"}
            </h2>

            <div className="p-6 space-y-3">
              <label className="block text-blue-800 font-semibold mb-1">Exam Type:</label>
              ...
              <label className="block text-blue-800 font-semibold mb-1">Question Type:</label>
              ...
              <label className="block text-blue-800 font-semibold mb-1">CLO:</label>
              ...
              <label className="block text-blue-800 font-semibold mb-1">Question Text:</label>
              ...
              <div className="flex justify-end space-x-3 mt-4">
                ...
                <button onClick={handleSaveQuestion} className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 transition-all">
